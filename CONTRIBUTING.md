...
First, in terms of structure, there is no particular concept of "aRIA Core
...
Before you start contributing, familiarize yourself with the aRIA Core build
system and tests. Refer to the documentation in the repository on how to build
aRIA Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/ariacurrency/aria/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/ariacurrency/aria/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[aRIA Core PR Review Club](https://aRIAcore.reviews/) meeting.
...
Most communication about aRIA Core development happens on IRC, in the
`#aRIA-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/aRIA-core-dev/](http://www.erisian.com.au/aRIA-core-dev/)
and [http://gnusha.org/aRIA-core-dev/](http://gnusha.org/aRIA-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/aRIA-dev)
...
For GUI-related issues or pull requests, the https://github.com/aRIA-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/ariacurrency/aria node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to aRIA-qt
...
fork of aRIA Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/ariacurrency/aria/blob/master/doc/translation_process.md)
...
The following applies to code changes to the aRIA Core project (and related
projects such as libsecp256k1), and is not to be confused with overall aRIA
...
https://github.com/ariacurrency/aria/pull/16189).

Also see the [backport.py script](
https://github.com/aRIA-core/aRIA-maintainer-tools#backport).
