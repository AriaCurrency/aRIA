...
By default, aRIA Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that aRIA's trustless model works best if you are
