...
This document provides guidelines for internationalization of the aRIA Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aRIA_en.ts` remains unchanged.
