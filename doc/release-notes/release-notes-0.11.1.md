aRIA Core version 0.11.1 is now available from:

  <https://aRIA.org/bin/aRIA-core-0.11.1/>
...
(see https://github.com/ariacurrency/aria/pull/6795).
...
one was randomly violated by all deployed aRIA software prior to
...
aRIA Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; aRIAj has done so for a similar span of time.
aRIAjs and electrum have been more recently updated.
...
[1] On the Malleability of aRIA Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/aRIA/paper_9.pdf
...
(see https://github.com/ariacurrency/aria/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libaRIAconsensus: avoid a crash in multi-threaded environments
