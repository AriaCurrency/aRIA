aRIA Core version 0.16.1 is now available from:

  <https://aRIAcore.org/bin/aRIA-core-0.16.1/>
...
- #12843 `df38b13` Test starting aRIAd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure aRIAd processes are cleaned up when tests end (sdaftuar)
