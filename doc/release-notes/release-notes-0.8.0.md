aRIA-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/aRIA/files/aRIA/aRIA-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the aRIA
...
New/changed settings (command-line or aRIA.conf file)
--------------------------------------------------------
