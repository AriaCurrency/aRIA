aRIA version 0.5.4 is now available for download at:
http://sourceforge.net/projects/aRIA/files/aRIA/aRIA-0.5.4/
...
http://gitorious.org/aRIA/aRIAd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix aRIA-Qt notifications under Growl 1.3.
Increase required age of aRIA-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxaRIA properly when installing aRIA-Qt over it. (Windows)
