aRIA Core version 0.13.2 is now available from:

  <https://aRIA.org/bin/aRIA-core-0.13.2/>
...
- #8908 `4a974b2` Update aRIA-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow aRIA-tx to create v2 transactions (BTCdrak)
