aRIA Core version 0.9.4 is now available from:

  https://aRIA.org/bin/0.9.4/
...
this update is incompatible with the aRIA system and could lead to consensus
forks.

aRIA Core released binaries from https://aRIA.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~aRIA/+archive/ubuntu/aRIA
- A third-party or self-compiled aRIA Core

upgrade to aRIA Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
