...
aRIA Core version 0.19.1 is now available from:

  <https://aRIAcore.org/bin/aRIA-core-0.19.1/>
...
From aRIA Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as aRIA Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, aRIA Core does not yet change appearance when
...
- #17488 fix "aRIAd already running" warnings on macOS (fanquake)
