aRIA Core version 0.10.4 is now available from:

  <https://aRIA.org/bin/aRIA-core-0.10.4/>
...
- #6953 `43c2789` Split aRIA-tx into its own package
- #6953 `dfe0d4d` Include aRIA-tx binary on Debian/Ubuntu
