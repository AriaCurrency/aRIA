...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/aRIA
else
  DOCKER_EXEC echo \> \$HOME/.aRIA
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/ariacurrency/aria/pull/18288#discussion_r433189350 for
  # details.
