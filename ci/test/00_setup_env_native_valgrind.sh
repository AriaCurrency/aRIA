#!/usr/bin/env bash
#
# Copyright (c) 2019-2020 The aRIA Core developers
...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude rpc_bind"  # Excluded for now, see https://github.com/ariacurrency/aria/issues/17765#issuecomment-602068547
export GOAL="install"
