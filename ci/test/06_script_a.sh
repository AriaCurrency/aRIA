...
export P_CI_DIR="${BASE_BUILD_DIR}/aRIA-$HOST"
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # details.
  DOCKER_EXEC 'grep -v HAVE_SYS_GETRANDOM src/config/aRIA-config.h > src/config/aRIA-config.h.tmp && mv src/config/aRIA-config.h.tmp src/config/aRIA-config.h'
fi
