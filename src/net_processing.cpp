    ...
    while (!orphan_work_set.empty()) {
        ...
        if (AcceptToMemoryPool(m_mempool, state, porphanTx, &removed_txn, false /* bypass_limits */)) {
            ...
            if (state.GetResult() != TxValidationResult::TX_WITNESS_STRIPPED) {
                ...
                // https://github.com/ariacurrency/aria/issues/8279 for details.
                // We can remove this restriction (and always add wtxids to
                // the filter even for witness stripped transactions) once
                // wtxid-based relay is broadly deployed.
                // See also comments in https://github.com/ariacurrency/aria/pull/18044#discussion_r443419034
...
static bool IsValidNodeProtocolVersion(CNode& pfrom, const int nVersion, const CChainParams& chain_params)
{
    ...
    if (::ChainActive().Height() < chain_params.GetConsensus().RIAColdStakeEnableHeight) {
