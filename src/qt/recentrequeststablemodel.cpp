    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return aRIAUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, aRIAUnits::SeparatorStyle::NEVER);
            else
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+aRIAUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
