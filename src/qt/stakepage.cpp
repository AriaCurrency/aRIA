...
void StakePage::setBalance(const interfaces::WalletBalances& balances)
{
    ...
    m_balances = balances;
    ui->labelAssets->setText(aRIAUnits::formatWithUnit(unit, balances.stakeable, false, aRIAUnits::SeparatorStyle::ALWAYS));
    ui->labelOwnedAssets->setText(aRIAUnits::formatWithUnit(unit, balances.stakeable - balances.stakeable_delegations, false, aRIAUnits::SeparatorStyle::ALWAYS));
    ui->labelDelegations->setText(aRIAUnits::formatWithUnit(unit, balances.stakeable_delegations, false, aRIAUnits::SeparatorStyle::ALWAYS));
    ui->labelAssetsImmature->setText(aRIAUnits::formatWithUnit(unit, balances.immature_stakeable, false, aRIAUnits::SeparatorStyle::ALWAYS));
    ...
    ui->labelStake->setText(aRIAUnits::formatWithUnit(unit, balances.stake, false, aRIAUnits::SeparatorStyle::ALWAYS));
    ui->labelDelegatedAssets->setText(aRIAUnits::formatWithUnit(unit, balances.delegated + balances.immature_delegated, false, aRIAUnits::SeparatorStyle::ALWAYS));
}
...
void StakePage::numBlocksChanged(int count, const QDateTime &, double, bool headers)
{
    ...
    {
        ui->labelHeight->setText(aRIAUnits::formatInt(count));
...
{
    int unit = walletModel->getOptionsModel()->getDisplayUnit();
    QString strSubsidy = aRIAUnits::formatWithUnit(unit, m_subsidy, false, aRIAUnits::SeparatorStyle::ALWAYS) + "/Block";
    ui->labelReward->setText(strSubsidy);
}

void StakePage::updateNetworkWeight()
{
    ui->labelWeight->setText(aRIAUnits::formatInt(m_networkWeight / COIN));
}
