...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, aRIAGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &aRIAGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &aRIAGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &aRIAGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &aRIAGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &aRIAGUI::updateWalletStatus);
    connect(gui, &aRIAGUI::setPrivacy, walletView, &WalletView::setPrivacy);
