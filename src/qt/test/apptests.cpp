...
//! Entry point for aRIAApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &aRIAApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for aRIAGUI tests.
void AppTests::guiTests(aRIAGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &aRIAGUI::consoleShown, this, &AppTests::consoleTests);
