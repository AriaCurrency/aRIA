...
/** aRIA adress type definitions. Encapsulates parsing
   and serves as list model for drop-down selection boxes.
*/
class aRIAAddressTypes: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit aRIAAddressTypes(QObject *parent);
...
typedef aRIAAddressTypes::AddressType aRIAAddressType;
