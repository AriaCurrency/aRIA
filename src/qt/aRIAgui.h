...
public:
    ...
    explicit aRIAGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~aRIAGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed aRIA Transaction from file or clipboard */
