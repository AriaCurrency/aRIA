        ...
        platformStyle(_platformStyle)
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label")
        << aRIAUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit())
        << aRIAUnits::getDelegatedColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
void TransactionTableModel::updateAmountColumnTitle()
{
    ...
    columns[Delegated] = aRIAUnits::getDelegatedColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxDelegated(const TransactionRecord *wtx, bool showUnconfirmed, aRIAUnits::SeparatorStyle separators) const
{
    QString str = aRIAUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->delegated, false, separators);
    if(showUnconfirmed)
    {
        if(!wtx->status.countsForBalance)
        {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, aRIAUnits::SeparatorStyle::ALWAYS);
        case Delegated:
            return formatTxDelegated(rec, true, aRIAUnits::SeparatorStyle::ALWAYS);
        }
        break;
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, aRIAUnits::SeparatorStyle::NEVER));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, aRIAUnits::SeparatorStyle::NEVER);
    case StatusRole:
