    ...
    mapper(nullptr)
{
    ...
    ui->aRIAAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->aRIAAtStartup);
    ...
    ui->aRIAAtStartup->setToolTip(ui->aRIAAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->aRIAAtStartup->setText(ui->aRIAAtStartup->text().arg(PACKAGE_NAME));

    ui->openaRIAConfButton->setToolTip(ui->openaRIAConfButton->toolTip().arg(PACKAGE_NAME));
...
void OptionsDialog::on_openaRIAConfButton_clicked()
{
