...
static void SetupaRIATxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aRIA-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aRIA-tx [options] <hex-tx> [commands]  Update hex-encoded aRIA transaction\n" +
            "or:     aRIA-tx [options] -create [commands]   Create hex-encoded aRIA transaction\n" +
            "\n";
