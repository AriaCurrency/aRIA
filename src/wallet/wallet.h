...
public:
     ...
     * on this aRIA node, and set to 0 for transactions that were created
...
private:
    ...
    void StakeRIAs(bool fStake, CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool);
