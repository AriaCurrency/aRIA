...
const char * const BITCOIN_CONF_FILENAME = "aRIA.conf";
 ...
 * https://github.com/ariacurrency/aria/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //aRIA-tx using stdin
        std::string val;
...
{
    // Windows: C:\Users\Username\AppData\Roaming\aRIA
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/aRIA";
#else
    // Unix-like
    return pathRet / ".aRIA";
#endif
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure aRIA Core copyright is not removed by accident
    if (copyright_devs.find("aRIA Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The aRIA Core developers";
    }
