...
/** Connect all aRIAd signal handlers */
void noui_connect();

/** Redirect all aRIAd signal handlers to LogPrintf. Used to check or suppress output during test runs that produce expected errors */
