...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    bool fColdStakingActive = ::ChainActive().Height() >= Params().GetConsensus().RIAColdStakeEnableHeight;
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/aRIA-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    {
       nSubsidy = 500000 * COIN; // 500,000 Premine
    }
    else if(nHeight<=27142858) // next 27142857 Blocks
    {
        nSubsidy = 0.35 * COIN; // 9,499,999.95
    }  
    else
    {
        nSubsidy = 0 * COIN;
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    if (pindex->nHeight > 5000 && !Params().MineBlocksOnDemand()) {
        ...
        if(pindex->nMoneySupply > (uint64_t)(210000000 + ((pindex->nHeight - 1000) * 50)) * COIN){
...
bool CheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig)
{
    ...
    bool fColdStakingActive = ::ChainActive().Height() >= consensusParams.RIAColdStakeEnableHeight;
    ...
    try {
        ...
        while (!blkdat.eof()) {
            ...
            try {
                ...
                // In aRIA POW this only needed to be done for genesis and at the end of block indexing
