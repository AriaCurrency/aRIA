// Copyright (c) 2019 The aRIA Core developers
...
/* A AEAD class for ChaCha20-Poly1305@aRIA.
 *
 ...
 *
 * The chacha20-poly1305@aRIA combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@aRIA cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@aRIA are relatively fast in
