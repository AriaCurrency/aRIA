...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the aRIA repository."
  exit 1
fi
...
# See https://github.com/ariacurrency/aria/issues/16064
...
echo 'When compiling aRIAd, run `./configure` in the following way:'
echo
