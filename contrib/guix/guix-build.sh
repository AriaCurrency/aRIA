...
# Deterministically build aRIA Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/aRIA/' to
        #     '/home/satoshi/aRIA/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/aRIA
        #
        #                     maps our current working directory to /aRIA
        ...
        #     container so that we have something to build. '/aRIA' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /aRIA && bash contrib/guix/libexec/build.sh"
    )
