# Bootstrappable aRIA Core Builds

This directory contains the files necessary to perform bootstrappable aRIA
Core builds.
...
- 24GB of free disk space on the partition that the aRIA Core git repository
  resides in
...
For a aRIA Core depends development environment, simply invoke
...
From the top of a clean aRIA Core repository:
...
To use dongcarl's substitute server for aRIA Core builds after having
