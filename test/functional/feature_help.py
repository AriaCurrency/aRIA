...
"""Verify that starting aRIA with -h works as expected."""

from test_framework.test_framework import aRIATestFramework
from test_framework.util import assert_equal

class HelpTest(aRIATestFramework):
    ...
    def run_test(self):
        self.log.info("Start aRIA with -h for help text")
        ...
        self.log.info("Start aRIA with -version for version information")
        ...
        self.log.info("Start aRIAd with -fakearg to make sure it does not start")
