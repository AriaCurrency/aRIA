...
By default, aRIAd will dump mempool on shutdown and
...
class MempoolPersistTest(aRIATestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent aRIAd from writing mempool.dat to disk. Verify that `savemempool` fails")
