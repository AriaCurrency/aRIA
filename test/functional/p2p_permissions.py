...
class P2PPermissionsTests(aRIATestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].aRIAconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].aRIAconf, 'w', encoding="utf8") as f:
            f.write(newText)
