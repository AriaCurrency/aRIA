...
"""Check that it's not possible to start a second aRIAd instance using the same datadir or wallet."""
import os

from test_framework.test_framework import aRIATestFramework
from test_framework.test_node import ErrorMatch

class FilelockTest(aRIATestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second aRIAd instance using the same datadir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second aRIAd instance using the same wallet")
