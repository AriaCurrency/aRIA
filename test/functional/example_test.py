...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the aRIATestFramework
    pass


class ExampleTest(aRIATestFramework):
    # Each functional test is a subclass of the aRIATestFramework class.
    ...
    def custom_method(self):
        ...
        aRIATestFramework class so other tests can use it."""
