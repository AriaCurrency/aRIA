...
class BumpFeeTest(aRIATestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 RIA (100,000 satoshis)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by aRIA to serialize ECDSA signatures means that signatures can have a
