#!/usr/bin/env python3
# Copyright (c) 2015-2019 The aRIA Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test aRIAd with different proxy configuration.

Test plan:
- Start aRIAd's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on aRIAd side:
...
class ProxyTest(aRIATestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: aRIAd's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
