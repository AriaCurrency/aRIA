...
# Copyright (c) 2010-2020 The aRIA Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""aRIA test framework primitive and message structures
...
# Objects that map to aRIAd objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/aRIA/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in aRIAd
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in aRIAd indicates these should be deserialized as blocks
