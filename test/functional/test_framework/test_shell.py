...
class TestShell:
    """Wrapper Class for aRIATestFramework.

    The TestShell class extends the aRIATestFramework
    ...
    class __TestShell(aRIATestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by aRIATestFramework child class.
            self.num_nodes = 1
