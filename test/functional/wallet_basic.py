...
class WalletTest(aRIATestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 RIA from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 RIA in block rewards plus fees, but
        ...
        # Send 10 RIA with subtract fee from amount
        ...
        # Sendmany 10 RIA with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid aRIA address
            assert_raises_rpc_error(-5, "Invalid aRIA address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid aRIA address
            assert_raises_rpc_error(-5, "Invalid aRIA address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid aRIA address or script", self.nodes[0].importaddress, "invalid")
